...
export class CrudproveedorService {
  ...
  obtenerProveedores(){
    return this.http.get(`${environment.ip}/Proveedor/VerTodos`,{headers:this.getHeaders()});
  }
  obtenerProveedorActualizar(id:any){
    return this.http.get(`${environment.ip}/Proveedor/Ver/${id}`,{headers:this.getHeaders()});
  }
