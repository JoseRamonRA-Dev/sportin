...
@Component({
  selector: 'app-membresia2',
  templateUrl: './membresia2.component.html',
  styleUrls: ['./membresia2.component.css']
})
export class Membresia2Component implements OnInit {
